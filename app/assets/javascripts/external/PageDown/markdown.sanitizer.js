(function () {
    ...
    var basic_tag_whitelist = /^(<\/?(b|blockquote|code|del|dd|dl|dt|em|h1|h2|h3|i|kbd|li|ol|p|s|sup|sub|strong|strike|ul|table|tbody|thead|tr|td|th|caption)>|<(br|hr)\s?\/?>)$/i;
