...
ActiveRecord::Schema.define(version: 20180712144341) do
  ...
  create_table "change_logs", force: :cascade do |t|
    ...
    t.integer  "source_id",        precision: 38
    t.integer  "documentation_id", precision: 38
    t.integer  "user_id",          precision: 38
  ...
  create_table "data", force: :cascade do |t|
    ...
    t.datetime "created_at",                                                  null: false
    t.datetime "updated_at",                                                  null: false
    t.integer  "event_id",                     precision: 38
  end
  ...
  create_table "data_dictionary", force: :cascade do |t|
    t.string   "title"
    t.text     "description"
    t.integer  "data_type_id",                    precision: 38
    t.integer  "min_value_id",                    precision: 38
    t.boolean  "min_value_inclusive", limit: nil
    t.integer  "max_value_id",                    precision: 38
    t.boolean  "max_value_inclusive", limit: nil
    t.boolean  "multivalue",          limit: nil,                default: false
    t.integer  "min_length",                      precision: 38
    t.string   "unit"
    t.boolean  "deleted",             limit: nil,                default: false, null: false
    t.datetime "created_at",                                                     null: false
    t.datetime "updated_at",                                                     null: false
  ...
  create_table "data_dictionary_data_values", force: :cascade do |t|
    t.integer  "data_dictionary_id", precision: 38
    t.integer  "data_value_id",      precision: 38
    t.datetime "created_at",                        null: false
    t.datetime "updated_at",                        null: false
  end
  ...
  create_table "data_quality_flags", force: :cascade do |t|
    t.integer  "datum_id",        precision: 38
    t.integer  "quality_flag_id", precision: 38
    t.datetime "created_at",                     null: false
    t.datetime "updated_at",                     null: false
  end
  ...
  create_table "data_types", force: :cascade do |t|
    t.string   "name"
    t.string   "storage"
    t.boolean  "range",      limit: nil
    t.boolean  "length",     limit: nil
    t.boolean  "values",     limit: nil
    t.boolean  "multiple",   limit: nil
    t.boolean  "deleted",    limit: nil, default: false, null: false
    t.datetime "created_at",                             null: false
    t.datetime "updated_at",                             null: false
  end
  ...
  create_table "data_values", force: :cascade do |t|
    ...
    t.datetime "updated_at",                                                 null: false
    t.integer  "datum_id",                    precision: 38
    t.integer  "time_offset_sec",             precision: 38
  end
  ...
  create_table "documentation_links", force: :cascade do |t|
    t.integer "documentation_id", precision: 38
    t.string  "title"
    t.string  "path"
  end
  ...
  create_table "event_dictionary", force: :cascade do |t|
    t.string   "name"
    t.text     "description"
    t.boolean  "deleted",     limit: nil,                default: false, null: false
    t.datetime "created_at",                                             null: false
    t.datetime "updated_at",                                             null: false
    t.integer  "paired_id",               precision: 38
  end
  ...
  create_table "event_dictionary_data_fields", force: :cascade do |t|
    t.integer  "event_dictionary_id", precision: 38
    t.integer  "data_dictionary_id",  precision: 38
    t.datetime "created_at",                         null: false
    t.datetime "updated_at",                         null: false
  end
  ...
  create_table "event_dictionary_event_tags", force: :cascade do |t|
    t.integer  "event_dictionary_id", precision: 38
    t.integer  "event_tag_id",        precision: 38
    t.datetime "created_at",                         null: false
    t.datetime "updated_at",                         null: false
  end
  ...
  create_table "event_quality_flags", force: :cascade do |t|
    t.integer  "event_id",        precision: 38
    t.integer  "quality_flag_id", precision: 38
    t.datetime "created_at",                     null: false
    t.datetime "updated_at",                     null: false
  ...
  create_table "events", force: :cascade do |t|
    ...
    t.integer  "source_id",                       precision: 38
    t.integer  "documentation_id",                precision: 38
    t.integer  "labtime_hour",                    precision: 38
    t.integer  "labtime_min",                     precision: 38
    t.integer  "labtime_sec",                     precision: 38
    t.integer  "labtime_year",                    precision: 38
    t.datetime "realtime"
    t.integer  "group_label",                     precision: 38
    t.boolean  "deleted",             limit: nil,                default: false, null: false
    t.datetime "created_at",                                                     null: false
    t.datetime "updated_at",                                                     null: false
    t.string   "labtime_timezone"
    t.integer  "realtime_offset_sec",             precision: 38
  end
  ...
  create_table "publications", force: :cascade do |t|
    t.integer  "pubmed_id",              precision: 38
    t.integer  "endnote_id",             precision: 38
    t.string   "title"
    t.string   "authors"
    t.string   "journal"
    t.string   "year"
  ...
  create_table "sources", force: :cascade do |t|
    t.integer  "source_type_id",                precision: 38
    t.integer  "user_id",                       precision: 38
    t.string   "location"
    t.text     "description"
    t.boolean  "deleted",           limit: nil,                default: false, null: false
  ...
  create_table "study_nicknames", force: :cascade do |t|
  ...
  create_table "subjects_pis", force: :cascade do |t|
    t.integer  "researcher_id", precision: 38
    t.integer  "subject_id",    precision: 38
    t.datetime "created_at",                   null: false
    t.datetime "updated_at",                   null: false
  end
  ...
  create_table "subjects_project_leaders", force: :cascade do |t|
    t.integer  "researcher_id", precision: 38
    t.integer  "subject_id",    precision: 38
    t.string   "role"
    t.text     "notes"
  ...
  create_table "subjects_publications", force: :cascade do |t|
    t.integer  "subject_id",     precision: 38
  ...
  create_table "subjects_subject_groups", force: :cascade do |t|
    t.integer "subject_id",       precision: 38
    t.integer "subject_group_id", precision: 38
  end
  ...
  create_table "supporting_documentations", force: :cascade do |t|
    t.integer "parent_id", precision: 38
    t.integer "child_id",  precision: 38
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean  "deleted",                limit: nil,                default: false,     null: false
    t.boolean  "system_admin",           limit: nil,                default: false,     null: false
  ...
  add_foreign_key "data", "events", name: "data_event_id_fk", on_delete: :nullify
  ...
  add_foreign_key "data_values", "data", name: "datum_id_fk", on_delete: :nullify
  ...
  add_foreign_key "event_dictionary", "event_dictionary", column: "paired_id", name: "event_dictionary_paired_id_fk", on_delete: :nullify
  ...
  add_foreign_key "source_types", "documentations", name: "sou_typ_doc_id_fk", on_delete: :nullify
  add_foreign_key "sources", "documentations", name: "sources_documentation_id_fk", on_delete: :nullify
  add_foreign_key "sources", "source_types", name: "sources_source_type_id_fk"
  add_foreign_key "sources", "sources", column: "parent_id", name: "sources_parent_id_fk", on_delete: :nullify
  add_foreign_key "sources", "subjects", name: "sources_subject_id_fk"
  add_foreign_key "sources", "users", name: "sources_user_id_fk"
  add_foreign_key "study_nicknames", "studies", name: "study_nicknames_study_id_fk", on_delete: :cascade
  add_foreign_key "subjects", "studies", name: "subjects_study_id_fk", on_delete: :nullify
  add_foreign_key "subjects_irbs", "irbs", name: "subjects_irbs_irb_id_fk", on_delete: :cascade
  add_foreign_key "subjects_irbs", "subjects", name: "subjects_irbs_subject_id_fk", on_delete: :cascade
  add_foreign_key "subjects_pis", "researchers", name: "subjects_pis_researcher_id_fk", on_delete: :cascade
  add_foreign_key "subjects_pis", "subjects", name: "subjects_pis_subject_id_fk", on_delete: :cascade
  add_foreign_key "subjects_project_leaders", "researchers", name: "sub_pro_lea_res_id_fk", on_delete: :cascade
  add_foreign_key "subjects_project_leaders", "subjects", name: "sub_pro_lea_sub_id_fk", on_delete: :cascade
  ...
  add_foreign_key "subjects_subject_groups", "subject_groups", name: "sub_sub_gro_sub_gro_id_fk", on_delete: :cascade
  add_foreign_key "subjects_subject_groups", "subjects", name: "sub_sub_gro_sub_id_fk", on_delete: :cascade
